...
- (void)layoutSubviews
{
    ...
    if (self.stateHidden) {
        ...
        CGSize size = LBL_TEXTSIZE(@"加载数据中...", MJRefreshLabelFont);
        
        self.activityView.center = CGPointMake(self.mj_w * 0.5 - size.width/2 - self.activityView.frame.size.width, self.mj_h * 0.5);
    }
}
